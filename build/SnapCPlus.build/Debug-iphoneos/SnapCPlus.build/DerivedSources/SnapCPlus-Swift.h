...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SnapCPlus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9SnapCPlus11AppDelegate")
...
SWIFT_CLASS("_TtC9SnapCPlus27CapturedImageViewController")
@interface CapturedImageViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified capturedImageView;
- (void)viewDidLoad;
- (IBAction)dismissButtonDidTouch:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC9SnapCPlus13SceneDelegate")
...
SWIFT_CLASS("_TtC9SnapCPlus14ViewController")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified captureImageThumbnailButton;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
- (void)viewDidLayoutSubviews;
- (IBAction)capturedImagethumbnailButtonTouch:(id _Nonnull)sender;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (IBAction)captureButtonDidTouch:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ViewController (SWIFT_EXTENSION(SnapCPlus)) <AVCapturePhotoCaptureDelegate>
